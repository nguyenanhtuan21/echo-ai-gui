        ...
        <div className="relative flex items-center gap-2 bg-chat-surface rounded-xl border border-chat-border p-1.5 hover-glow">
          ...
          <div className="flex-1 min-h-[36px] flex items-center">
            <Textarea
              ...
              className="w-full min-h-[36px] max-h-[120px] border-0 bg-transparent resize-none focus:ring-0 focus:outline-none py-2.5 px-2 text-chat-text placeholder:text-chat-text-muted text-sm leading-[1.4] flex items-center"
              disabled={disabled}
              style={{ height: 'auto' }}
            />
          </div>
